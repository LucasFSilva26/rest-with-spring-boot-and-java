...
import com.lucas.controllers.BookController;
...
import com.lucas.mapper.DozerMapper;
...
public class BookServices {
	...
	public BookVO update(BookVO book) {
		...
		var vo = DozerMapper.parseObject(repository.save(entity), BookVO.class);
		vo.add(linkTo(methodOn(BookController.class).findById(vo.getKey())).withSelfRel()); //TROCAR CONTROLLER
		return vo;
	}
